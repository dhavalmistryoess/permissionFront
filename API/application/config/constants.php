...
define('ITEM_ALL', 'item_all');
define('CATEGORY_ALL', 'category_all');
define('DISCOUNT_ALL', 'discount_all');
...
//define('ACTIVE_GROUP', 'Development'); // database mode
 ...
 define('API_BASE_URL', 'http://permissionapi.dev.local/'); // API local Base URL
 define('BASE_URL', 'http://localhost:4200/'); // Frontend local Base URL
 define('FILE_DIR', './assests/Documents/');
