    ...
    if (userAssessmentId) {
      ...
      this.AssessmentdetailService.getAssessmentDetails(userAssessmentId,hasProctor)
        .then((data) => {
          ...
          this.AssessmentEntity = data['AssessmentDetails']['AssessmentDetails'][0];
          if(this.AssessmentEntity.TimeOfAssessment < 60)
          {
            this.totaltimetaken = this.AssessmentEntity.TimeOfAssessment + " mintues";
          }
          else{
            var s = this.AssessmentEntity.TimeOfAssessment*60;
          ...
          this.summaryquestions = data['AssessmentDetails']['data'];
          this.ResultList = data['AssessmentDetails']['result'];
          var ResultList = this.ResultList;
          this.AssessmentPreviewList = data['ResultPreview'];
          setTimeout(function () {
