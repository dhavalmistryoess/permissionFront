...
@Component({
  selector: 'app-assessment-panel-changes',
  templateUrl: './assessment-panel-changes.component.html',
  styleUrls: ['./assessment-panel-changes.component.css']
})
export class AssessmentPanelChangesComponent implements OnInit,OnDestroy  {
