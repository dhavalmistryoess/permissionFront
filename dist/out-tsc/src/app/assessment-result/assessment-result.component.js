...
var AssessmentResultComponent = /** @class */ (function () {
    function AssessmentResultComponent(router, globals, route, ResultPageService) {
        this.router = router;
    ...
    AssessmentResultComponent.prototype.ngOnInit = function () {
        ...
        if (id) {
            ...
            this.ResultPageService.getAssessmentResultById(id)
                ...
                _this.resultEntity = data['result']['result'];
                _this.summary = data['result']['data'];
                _this.certificateEntity = data['certificate'];
                resultEntity = data['result']['result'];
                _this.Certiname = _this.resultEntity[0];
                if (_this.Certiname.TimeOfAssessment < 60) {
                    _this.totaltimetaken = _this.Certiname.TimeOfAssessment + " mintues";
                }
                else {
                    var s = _this.Certiname.TimeOfAssessment * 60;
    ...
    // }
    AssessmentResultComponent.prototype.certificate = function () {
    ...
    AssessmentResultComponent = tslib_1.__decorate([
        Component({
...
export { AssessmentResultComponent };
//# sourceMappingURL=assessment-result.component.js.map